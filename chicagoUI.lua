...
if ( system.getInfo("environment") == "simulator" ) then
    keyInput = require( "keyboardInput" )
    keyInput.init()
end
...
function ui:init(scene)
	...
	if ( system.getInfo("environment") == "simulator" ) then
        keyInput.init( mainScene.ui.jumpButton.icon, mainScene.ui.fireButton.icon, mainScene.ui.dashButton.icon, self.specialPowersButton.icon )
        mainScene.ui.jumpButton.icon:addKeyboardListener( "keyboard_z", mainScene.ui.jumpButton.activate, { phase="began" } )
        mainScene.ui.fireButton.icon:addKeyboardListener( "keyboard_m", mainScene.ui.fireButton.activate, { phase="began" } )
        mainScene.ui.dashButton.icon:addKeyboardListener( "keyboard_x", mainScene.ui.dashButton.activate, { phase="began" } )
      mainScene.ui.specialPowersButton.icon:addKeyboardListener( "keyboard_n", mainScene.ui.specialPowersButton.activate, { phase="began" } )
    ...
    if( mainScene:getSelectedCharacter() == "perry" ) then
     ...
     gradient = display.newImageRect( "images/hitOverlay.gif", 200, 200 )
